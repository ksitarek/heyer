...
public class CreateJobOfferValidatorTests
{
    ...
    private const string ValidJobDescription = "saacpecnienlzckquxujarumjjothtjzewflnjfrjcsemhdqxjybttlurbgkongmaorbedvmoocpibvbwxfljntgcvplywqgipiryoxapjvphpwtrqmuqavehdkjvadf";
    private const string TooLongOfferSummary = "";
    ...
    public void SetUp()
    {
        _validator = new CreateJobOfferValidator();
    }
    ...
    {
        yield return [TooShortOfferSummary, $"The length of 'Offer Summary' must be at least 10 characters. You entered {TooShortOfferSummary.Length} characters."];
        yield return [TooLongOfferSummary, $"The length of 'Offer Summary' must be 100 characters or fewer. You entered {TooLongOfferSummary.Length} characters."];
    ...
    {
        yield return [TooShortJobDescription, $"The length of 'Job Description' must be at least 100 characters. You entered {TooShortJobDescription.Length} characters."];

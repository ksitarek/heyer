...
public class CreateJobOfferEndpointTests : JobModuleIntegrationTestsBase
{
    ...
    public async Task CreateJobOfferEndpoint_WithInvalidData_WillReturn400(
        string offerSummary, string jobDescription, RemoteWork remoteWork, string erroredField, string[] validationErrors)
    {
        // Arrange
    ...
    public static IEnumerable<object[]> BadRequestTestCases()
    {
        ...
        var validJobDescription = "saacpecnienlzckquxujarumjjothtjzewflnjfrjcsemhdqxjybttlurbgkongmaorbedvmoocpibvbwxfljntgcvplywqgipiryoxapjvphpwtrqmuqavehdkjvadf";
        var tooShortJobDescription = "wyqxu";
        
        var validRemoteWork = f.Random.Enum(RemoteWork.Unknown);

#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
        yield return [null, validJobDescription, validRemoteWork, "OfferSummary", new[] {"'Offer Summary' must not be empty."}];
        yield return [string.Empty, validJobDescription, validRemoteWork, "OfferSummary", new[] {"'Offer Summary' must not be empty.", "The length of 'Offer Summary' must be at least 10 characters. You entered 0 characters."}];
        yield return [tooShortOfferSummary, validJobDescription, validRemoteWork, "OfferSummary", new[] {$"The length of 'Offer Summary' must be at least 10 characters. You entered {tooShortOfferSummary.Length} characters."}];
        yield return [tooLongOfferSummary, validJobDescription, validRemoteWork, "OfferSummary", new[] {$"The length of 'Offer Summary' must be 100 characters or fewer. You entered {tooLongOfferSummary.Length} characters."}];
        
        yield return [validOfferSummary, null, validRemoteWork, "JobDescription", new[] {"'Job Description' must not be empty."}];
        yield return [validOfferSummary, string.Empty, validRemoteWork, "JobDescription", new[] {"'Job Description' must not be empty.", "The length of 'Job Description' must be at least 100 characters. You entered 0 characters."}];
        yield return [validOfferSummary, tooShortJobDescription, validRemoteWork, "JobDescription", new[] {$"The length of 'Job Description' must be at least 100 characters. You entered {tooShortJobDescription.Length} characters."}];
        
        yield return [validOfferSummary, validJobDescription, null, "RemoteWork", new[] {"Remote work must be specified."}];
        yield return [validOfferSummary, validJobDescription, RemoteWork.Unknown, "RemoteWork", new[] {"Remote work must be specified."}];

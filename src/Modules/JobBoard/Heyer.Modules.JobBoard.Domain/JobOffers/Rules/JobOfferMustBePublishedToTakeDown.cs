...
public class JobOfferMustBePublishedToTakeDown : IBusinessRule
{
    ...
    public JobOfferMustBePublishedToTakeDown(DateTimeOffset? publishedAt)
    {
    ...
    {
        return Result.OkIf(_publishedAt is not null, "Job offer must be published to take it down.");
    }
}
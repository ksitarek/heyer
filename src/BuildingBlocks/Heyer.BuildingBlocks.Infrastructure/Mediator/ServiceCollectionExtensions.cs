...
{
    public static IServiceCollection AddMediator(this IServiceCollection services, IModule[] modules, params Type[] pipelineBehaviors)
    {
    ...
    {
        return services.AddMediator([Assembly.GetCallingAssembly()], pipelineBehaviors);
    }

    private static IServiceCollection AddMediator(this IServiceCollection services, Assembly[] assemblies, Type[] pipelineBehaviors)
    {
